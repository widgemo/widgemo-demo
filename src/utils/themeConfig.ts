...
export const THEME_CONFIGS: Record<string, ThemeConfig> = {
  ...
  'theme-light-blue': {
    ...
    buttonHover: '#99d6ff',
    rowHoverBg: '#99d6ff',
    tableHeaderHoverBg: '#f0f8ff',
    tableBorder: '#b3d9ff',
    tableHeaderBg: '#f0f8ff',
    tableBodyBg: '#f0f8ff',
    rowAltBg: '#f5fbff',
    focusColor: '#007bff',
    textMuted: '#6c757d',
  ...
  'theme-light-green': {
    ...
    buttonHover: '#99ff99',
    rowHoverBg: '#99ff99',
    tableHeaderHoverBg: '#f0fff0',
    tableBorder: '#b3ffb3',
    tableHeaderBg: '#f0fff0',
    tableBodyBg: '#f0fff0',
    rowAltBg: '#f5fff5',
    focusColor: '#28a745',
    textMuted: '#6c757d',
  ...
  'theme-light-purple': {
    ...
    buttonHover: '#d9b3ff',
    rowHoverBg: '#d9b3ff',
    tableHeaderHoverBg: '#f8f0ff',
    tableBorder: '#d9b3ff',
    tableHeaderBg: '#f8f0ff',
    tableBodyBg: '#f8f0ff',
    rowAltBg: '#fbf5ff',
    focusColor: '#6f42c1',
    textMuted: '#6c757d',
  ...
  'theme-dark-red': {
    ...
    buttonHover: '#6a4a4a',
    rowHoverBg: '#6a4a4a',
    tableHeaderHoverBg: '#2a1a1a',
    tableBorder: '#664444',
    tableHeaderBg: '#2a1a1a',
    tableBodyBg: '#2a1a1a',
    rowAltBg: '#332222',
    focusColor: '#dc3545',
    textMuted: '#888888',
