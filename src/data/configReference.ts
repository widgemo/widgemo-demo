...
export const widgemoConfigProperties: Array<{
  ...
  { category: 'WidgemoConfig', property: 'chartConfig.type', type: "'bar' | 'line' | 'pie' | 'area' | 'scatter'", status: 'implemented', description: 'Chart type', usage: 'Basic chart types supported.', example: "'bar'" },
  { category: 'WidgemoConfig', property: 'chartConfig.xAxis', type: 'string', status: 'implemented', description: 'X-axis field name', usage: 'Field for chart x-axis.', example: "'name'" },
  { category: 'WidgemoConfig', property: 'chartConfig.yAxis', type: 'string | string[]', status: 'implemented', description: 'Y-axis field name(s)', usage: 'Field(s) for chart y-axis.', example: "'value'" },
  { category: 'WidgemoConfig', property: 'chartConfig.groupBy', type: 'string', status: 'not-implemented', description: 'Field to group data by', usage: 'Not implemented.', example: "'category'" },
  { category: 'WidgemoConfig', property: 'chartConfig.settings', type: 'Record<string, any>', status: 'partial', description: 'Additional chart settings', usage: 'Passed to Recharts components.', example: '{ showLegend: true }' },
  ...
  { category: 'WidgemoConfig', property: 'filtering.enabled', type: 'boolean', status: 'not-implemented', description: 'Enable filtering', usage: 'Not implemented.', example: 'true' },
  { category: 'WidgemoConfig', property: 'filtering.filters', type: 'Array<{ field: string; type: "text" | "select" | "date" | "number" | "boolean"; options?: Array<{ value: any; label: string }> }>', status: 'not-implemented', description: 'Filter definitions', usage: 'Not implemented.', example: '[{ field: "status", type: "select", options: [{ value: "active", label: "Active" }] }]' },
  ...
  { category: 'WidgemoConfig', property: 'styling.className', type: 'string', status: 'implemented', description: 'Additional CSS class name', usage: 'Applied to root element.', example: '"my-custom-class"' },
  { category: 'WidgemoConfig', property: 'styling.theme', type: "'light' | 'dark' | 'auto'", status: 'implemented', description: 'Theme selection', usage: 'Controls color scheme.', example: "'dark'" },
  { category: 'WidgemoConfig', property: 'styling.compact', type: 'boolean', status: 'implemented', description: 'Compact spacing and sizing', usage: 'Reduces padding and margins.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.shadow', type: 'boolean', status: 'implemented', description: 'Show shadow for the component', usage: 'Adds drop shadow.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.showBorder', type: 'boolean', status: 'implemented', description: 'Show border for the component', usage: 'Adds border around component.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.dynamicBackground', type: 'boolean', status: 'implemented', description: 'Adapt background color based on theme', usage: 'Automatically adjusts background.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.table', type: 'Object', status: 'implemented', description: 'Table-specific styling options', usage: 'Controls table appearance.', example: '{ showBorder: true, cellBorder: true }' },
  { category: 'WidgemoConfig', property: 'styling.table.showBorder', type: 'boolean', status: 'implemented', description: 'Show table border', usage: 'Adds border around table.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.table.borderStyle', type: 'string', status: 'implemented', description: 'Table border style', usage: 'CSS border-style property.', example: "'solid'" },
  { category: 'WidgemoConfig', property: 'styling.table.borderWidth', type: 'string', status: 'implemented', description: 'Table border width', usage: 'CSS border-width property.', example: "'1px'" },
  { category: 'WidgemoConfig', property: 'styling.table.borderColor', type: 'string', status: 'implemented', description: 'Table border color', usage: 'CSS border-color property.', example: "'#ddd'" },
  { category: 'WidgemoConfig', property: 'styling.table.cellBorder', type: 'boolean', status: 'implemented', description: 'Show borders between cells', usage: 'Adds borders between table cells.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.table.headerBorder', type: 'boolean', status: 'implemented', description: 'Show border under header row', usage: 'Adds border below table header.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.table.backgroundColor', type: 'string', status: 'implemented', description: 'Table background color', usage: 'Sets table background.', example: "'#ffffff'" },
  { category: 'WidgemoConfig', property: 'styling.card', type: 'Object', status: 'implemented', description: 'Card-specific styling options', usage: 'Controls card appearance.', example: '{ showBorder: true, shadow: true }' },
  { category: 'WidgemoConfig', property: 'styling.card.showBorder', type: 'boolean', status: 'implemented', description: 'Show card borders', usage: 'Adds borders around cards.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.card.borderStyle', type: 'string', status: 'implemented', description: 'Card border style', usage: 'CSS border-style property.', example: "'solid'" },
  { category: 'WidgemoConfig', property: 'styling.card.borderWidth', type: 'string', status: 'implemented', description: 'Card border width', usage: 'CSS border-width property.', example: "'1px'" },
  { category: 'WidgemoConfig', property: 'styling.card.borderColor', type: 'string', status: 'implemented', description: 'Card border color', usage: 'CSS border-color property.', example: "'#ddd'" },
  { category: 'WidgemoConfig', property: 'styling.card.borderRadius', type: 'string', status: 'implemented', description: 'Card border radius', usage: 'CSS border-radius property.', example: "'8px'" },
  { category: 'WidgemoConfig', property: 'styling.card.shadow', type: 'boolean', status: 'implemented', description: 'Show card drop shadow', usage: 'Adds shadow to cards.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.card.backgroundColor', type: 'string', status: 'implemented', description: 'Card background color', usage: 'Sets card background.', example: "'#ffffff'" },
  { category: 'WidgemoConfig', property: 'styling.grid', type: 'Object', status: 'partial', description: 'Grid-specific styling options', usage: 'Controls grid layout.', example: '{ columns: 3, gap: "10px" }' },
  { category: 'WidgemoConfig', property: 'styling.grid.columns', type: 'number | "auto"', status: 'implemented', description: 'Number of grid columns', usage: 'Sets grid column count.', example: '3' },
  { category: 'WidgemoConfig', property: 'styling.grid.cellSize', type: 'Object', status: 'not-implemented', description: 'Grid cell dimensions', usage: 'Not implemented.', example: '{ width: 200, height: 150 }' },
  { category: 'WidgemoConfig', property: 'styling.grid.gap', type: 'string', status: 'implemented', description: 'Gap between grid items', usage: 'CSS gap property.', example: "'10px'" },
  { category: 'WidgemoConfig', property: 'styling.grid.showGridLines', type: 'boolean', status: 'not-implemented', description: 'Show grid lines', usage: 'Not implemented.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.grid.aspectRatio', type: 'string', status: 'not-implemented', description: 'Grid aspect ratio', usage: 'Not implemented.', example: "'16/9'" },
  { category: 'WidgemoConfig', property: 'styling.grid.backgroundColor', type: 'string', status: 'implemented', description: 'Grid background color', usage: 'Sets grid background.', example: "'#f5f5f5'" },
  { category: 'WidgemoConfig', property: 'styling.grid.imageGrid', type: 'Object', status: 'not-implemented', description: 'Image grid configuration', usage: 'Not implemented.', example: '{ masonry: true }' },
  { category: 'WidgemoConfig', property: 'styling.grid.imageGrid.masonry', type: 'boolean', status: 'not-implemented', description: 'Enable masonry layout', usage: 'Not implemented.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.board', type: 'Object', status: 'partial', description: 'Board-specific styling options', usage: 'Controls kanban board appearance.', example: '{ draggable: true, showColumnHeaders: true }' },
  { category: 'WidgemoConfig', property: 'styling.board.columns', type: 'Array<{ id: string; label?: string }>', status: 'implemented', description: 'Board column definitions', usage: 'Defines kanban columns.', example: '[{ id: "todo", label: "To Do" }]' },
  { category: 'WidgemoConfig', property: 'styling.board.groupBy', type: 'string', status: 'not-implemented', description: 'Field to group items by', usage: 'Not implemented.', example: '"status"' },
  { category: 'WidgemoConfig', property: 'styling.board.swimlanes', type: 'Array<{ id: string; label?: string }>', status: 'not-implemented', description: 'Swimlane definitions', usage: 'Not implemented.', example: '[{ id: "high", label: "High Priority" }]' },
  { category: 'WidgemoConfig', property: 'styling.board.swimlaneBy', type: 'string', status: 'not-implemented', description: 'Field for swimlane grouping', usage: 'Not implemented.', example: '"priority"' },
  { category: 'WidgemoConfig', property: 'styling.board.draggable', type: 'boolean', status: 'partial', description: 'Enable drag and drop', usage: 'Basic drag logic exists.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.board.showColumnHeaders', type: 'boolean', status: 'implemented', description: 'Show column headers', usage: 'Displays column titles.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.board.showItemCount', type: 'boolean', status: 'not-implemented', description: 'Show item count in columns', usage: 'Not implemented.', example: 'true' },
  { category: 'WidgemoConfig', property: 'styling.board.minColumnWidth', type: 'string', status: 'not-implemented', description: 'Minimum column width', usage: 'Not implemented.', example: "'200px'" },
  { category: 'WidgemoConfig', property: 'styling.board.gap', type: 'string', status: 'implemented', description: 'Gap between columns', usage: 'CSS gap property.', example: "'10px'" },
  { category: 'WidgemoConfig', property: 'styling.board.imagePlacement', type: 'string', status: 'implemented', description: 'Image placement in board cards', usage: 'Controls image position.', example: "'header'" },
  { category: 'WidgemoConfig', property: 'styling.board.columnCornerRadius', type: 'string', status: 'not-implemented', description: 'Corner radius for columns', usage: 'Not implemented.', example: "'8px'" },
  ...
  { category: 'WidgemoConfig', property: 'emptyState.message', type: 'string', status: 'implemented', description: 'Empty state message', usage: 'Displayed when no data.', example: '"No items found"' },
  { category: 'WidgemoConfig', property: 'emptyState.icon', type: 'React.ComponentType', status: 'implemented', description: 'Empty state icon component', usage: 'Custom icon for empty state.', example: 'MyIconComponent' },
  { category: 'WidgemoConfig', property: 'emptyState.action', type: 'Object', status: 'implemented', description: 'Empty state action button', usage: 'Button shown in empty state.', example: '{ label: "Add Item", onClick: () => {} }' },
  { category: 'WidgemoConfig', property: 'emptyState.action.label', type: 'string', status: 'implemented', description: 'Action button label', usage: 'Text for action button.', example: '"Create New"' },
  { category: 'WidgemoConfig', property: 'emptyState.action.onClick', type: '() => void', status: 'implemented', description: 'Action button click handler', usage: 'Function called when button clicked.', example: '() => setShowAddModal(true)' },
  ...
  { category: 'WidgemoConfig', property: 'header.discoverable', type: 'string[]', status: 'implemented', description: 'Buttons shown on hover', usage: 'Controls shown when hovering header.', example: '["viewToggle", "columnSelector"]' },
  { category: 'WidgemoConfig', property: 'header.always', type: 'string[]', status: 'implemented', description: 'Buttons always visible', usage: 'Controls always shown in header.', example: '["refresh", "add"]' },
  { category: 'WidgemoConfig', property: 'header.onMenu', type: 'string[]', status: 'not-implemented', description: 'Buttons in dropdown menu', usage: 'Not implemented.', example: '["export", "import"]' },
  { category: 'WidgemoConfig', property: 'header.includeDeleted', type: 'boolean', status: 'not-implemented', description: 'Include deleted records', usage: 'Not implemented.', example: 'false' },
  ...
  { category: 'WidgemoConfig', property: 'imagesConfig.field', type: 'string', status: 'implemented', description: 'Image source field path', usage: 'Dot notation path to image field.', example: '"thumbnail.url"' },
  { category: 'WidgemoConfig', property: 'imagesConfig.fit', type: "'cover' | 'contain' | 'fill' | 'none' | 'scale-down'", status: 'implemented', description: 'CSS object-fit property', usage: 'Controls image sizing.', example: "'cover'" },
  { category: 'WidgemoConfig', property: 'imagesConfig.lazy', type: 'boolean', status: 'implemented', description: 'Enable lazy loading', usage: 'Loads images on demand.', example: 'true' },
  { category: 'WidgemoConfig', property: 'imagesConfig.altFn', type: '(item: any) => string', status: 'implemented', description: 'Alt text generator function', usage: 'Generates alt text from item data.', example: '(item) => item.name' },
  { category: 'WidgemoConfig', property: 'imagesConfig.loadingPlaceholder', type: 'string', status: 'implemented', description: 'Loading placeholder image', usage: 'Shown while image loads.', example: '"/loading.gif"' },
  { category: 'WidgemoConfig', property: 'imagesConfig.errorPlaceholder', type: 'string', status: 'implemented', description: 'Error placeholder image', usage: 'Shown when image fails.', example: '"/error.png"' },
  { category: 'WidgemoConfig', property: 'imagesConfig.showTextOverlay', type: 'boolean', status: 'implemented', description: 'Show text overlay on images', usage: 'Overlays text on images.', example: 'true' },
